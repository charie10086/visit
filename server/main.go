//Package main generated by 'freedom new-project visit'
package main
...
import (
	...
	"gorm.io/gorm"
	"time"
	_ "visit/adapter/controller" //引入输入适配器 http路由
	_ "visit/adapter/repository" //引入输出适配器 repository资源库
	"visit/server/conf"
)
